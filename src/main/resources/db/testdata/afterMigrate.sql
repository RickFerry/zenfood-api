...
insert into restaurantes (nome, taxa_frete, ativo, aberto, data_cadastro, data_atualizacao, cozinha_id, cep, logradouro, numero, complemento, bairro, cidade_id) values ('Restaurante 1', 10.0, true, true, utc_timestamp, utc_timestamp, 1, '13050-255', 'Rua Floriano Peixoto', '105', 'Apto 202', 'Centro', 1);
insert into restaurantes (nome, taxa_frete, ativo, aberto, data_cadastro, data_atualizacao, cozinha_id, cep, logradouro, numero, complemento, bairro, cidade_id) values ('Restaurante 2', 15.0, true, true, utc_timestamp, utc_timestamp, 2, '13050-255', 'Rua Floriano Peixoto', '105', 'Apto 202', 'Centro', 2);
insert into restaurantes (nome, taxa_frete, ativo, aberto, data_cadastro, data_atualizacao, cozinha_id, cep, logradouro, numero, complemento, bairro, cidade_id) values ('Restaurante 3', 20.0, true, true, utc_timestamp, utc_timestamp, 3, '13050-255', 'Rua Floriano Peixoto', '105', 'Apto 202', 'Centro', 3);
insert into restaurantes (nome, taxa_frete, ativo, aberto, data_cadastro, data_atualizacao, cozinha_id, cep, logradouro, numero, complemento, bairro, cidade_id) values ('Restaurante 4', 25.0, true, true, utc_timestamp, utc_timestamp, 4, '13050-255', 'Rua Floriano Peixoto', '105', 'Apto 202', 'Centro', 4);
insert into restaurantes (nome, taxa_frete, ativo, aberto, data_cadastro, data_atualizacao, cozinha_id, cep, logradouro, numero, complemento, bairro, cidade_id) values ('Restaurante 5', 30.0, true, true, utc_timestamp, utc_timestamp, 5, '13050-255', 'Rua Floriano Peixoto', '105', 'Apto 202', 'Centro', 5);
